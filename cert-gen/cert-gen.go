...
func generateSCertificateServer(caCert *x509.Certificate, cakey *ecdsa.PrivateKey) (bool, *ecdsa.PrivateKey, []byte){
	...
	serverCertBytes, err := client.GenerateClientCertificate(caCert, cakey, serverKey, time.Now().AddDate(1, 0, 0), "controller")
...
func GenerateNewClient(caKey string, certCA string, msg string, path string, ENV bool, variableName string, variableKeyName string) bool {
...
func GenerateNewServer(caKey string, certCA string, msg string, path string, ENV bool, variableName string, variableNameKey string) bool {
...
func GenerateClientCert(caCert *x509.Certificate, caCertificateBytes []byte, cakey *ecdsa.PrivateKey, msg string, path string, ENV bool, variableName string, variableNameKey string) (bool){
...
func GenerateServerCert(caCert *x509.Certificate, cakey *ecdsa.PrivateKey, caCertificateBytes []byte, msg string, path string, ENV bool, variableName string, variableKeyName string) bool {
